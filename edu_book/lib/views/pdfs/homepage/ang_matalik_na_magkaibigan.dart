...
class AngMatalikNaMagkaibigan extends StatelessWidget {
  AngMatalikNaMagkaibigan({Key? key, required this.pdfAssetPath})
      : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Consumer(builder: (context, ThemeModal themeNotifier, child) {
      return Scaffold(
        appBar: AppBar(
          title: const Text('Ang Matalik na Magkaibigan'),
          actions: <Widget>[
